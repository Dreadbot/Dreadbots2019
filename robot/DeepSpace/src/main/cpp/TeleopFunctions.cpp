...
void Robot::Climb(int level)
{
  ...
  std::cout << " Back Height: " << stilts->getBackHeight();
    if (climbState != 8 && level == 3)
    {
      ...
      else if (climbState == 4 && ultra->getDistanceLeftBack() <= 7 && ultra->getDistanceLeftBack() >= 1 && ultra->getDistanceRightBack() <= 7 && ultra->getDistanceRightBack() >= 1 && climbTimeout >= 100)
      {
